...
namespace FIA_Biosum_Manager
{
	...
	public class uc_datasource_edit : System.Windows.Forms.UserControl
	{
		...
		#endregion
		private void InitializeComponentSqlite()
		{
			this.groupBox1 = new System.Windows.Forms.GroupBox();
			this.btnHelp = new System.Windows.Forms.Button();
			this.progressBar1 = new System.Windows.Forms.ProgressBar();
			...
			this.btnCommitChange.TabIndex = 30;
			this.btnCommitChange.Text = "Commit Change";
			this.btnCommitChange.Click += new System.EventHandler(this.btnCommitChange_ClickSqlite);
			// 
			// btnClose
			// 
			this.btnClose.Location = new System.Drawing.Point(592, 416);
			...
			this.btnFile.Click += new System.EventHandler(this.btnFile_ClickSqlite);
			// 
			// lblMDBFile
			// 
			this.lblMDBFile.BackColor = System.Drawing.Color.White;
		...
		private void btnFile_ClickSqlite(object sender, System.EventArgs e)
        {
			string strFullPath;
			string strLargestString = "";
		...
		private void btnCommitChange_ClickSqlite(object sender, System.EventArgs e)
        {
			string strConn = "";
			string strDir = "";
			string strFile = "";
