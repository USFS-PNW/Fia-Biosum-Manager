...
namespace FIA_Biosum_Manager
{
	...
	public class uc_optimizer_scenario_run : System.Windows.Forms.UserControl
	{
        ...
        private int val_travelTimesDatasourceMatch()
        {
            ...
            for (x = 0; x <= ReferenceOptimizerScenarioForm.m_oOptimizerScenarioItem.m_oProcessorScenarioItem_Collection.Count - 1; x++)
            {
                ...
                {
                    string strProcessorRuleDefsDb = frmMain.g_oFrmMain.frmProject.uc_project1.m_strProjectDirectory.Trim() +
	...
	public class RunOptimizer
	{
            ...
            try
            {
                ...
                if (frmMain.g_bDebug)
                {
                    ...
                    if (frmMain.g_intDebugLevel > 1)
                    {
                        ...
                        frmMain.g_oUtils.WriteText(m_strDebugFile, "Project Directory: " + frmMain.g_oFrmMain.frmProject.uc_project1.m_strProjectDirectory + "\r\n");
        ...
        private void FilterPSites()
        {
            ...
            using (System.Data.SQLite.SQLiteConnection workConn = new System.Data.SQLite.SQLiteConnection(m_strWorkTablesConn))
            {
                ...
                p_dataMgr.m_strSQL = "ATTACH DATABASE '" + frmMain.g_oFrmMain.frmProject.uc_project1.m_strProjectDirectory.Trim() + "\\" + 
        ...
        private void sumTreeVolVal()
        {
            ...
            using (System.Data.SQLite.SQLiteConnection workConn = new System.Data.SQLite.SQLiteConnection(m_strWorkTablesConn))
            {
                ...
                p_dataMgr.m_strSQL = "INSERT INTO " + m_strTreeVolValSumTable +
                    ...
                    "SUM(s.merch_vol_cf) + SUM(s.wood4_vol_cf) + SUM(s.wood5_vol_cf) + SUM(s.wood6_vol_cf) AS non_residue_vol_cf, " +
                    "s.place_holder " +
        ...
        private void validcombos()
        {
            ...
            using (System.Data.SQLite.SQLiteConnection workConn = new System.Data.SQLite.SQLiteConnection(m_strWorkTablesConn))
            {
                ...
                p_dataMgr.m_strSQL = "ATTACH DATABASE '" + frmMain.g_oFrmMain.frmProject.uc_project1.m_strProjectDirectory.Trim() + "\\" + Tables.OptimizerScenarioResults.DefaultCalculatedPrePostFVSVariableTableDbFile + "' AS calc_prepost_fvsout";
                p_dataMgr.SqlNonQuery(workConn, p_dataMgr.m_strSQL);

                p_dataMgr.m_strSQL = "ATTACH DATABASE '" + frmMain.g_oFrmMain.frmProject.uc_project1.m_strProjectDirectory.Trim() + Tables.FVS.DefaultFVSOutPrePostDbFile + "' AS prepost_fvsout";
                p_dataMgr.SqlNonQuery(workConn, p_dataMgr.m_strSQL);
                ...
                p_dataMgr.m_strSQL = "DELETE FROM validcombos AS v " +
                    ...
                    "WHERE v.biosum_cond_id = p.biosum_cond_id AND p.merch_haul_psite IS NULL AND p.chip_haul_psite IS NULL AND p.wood4_haul_psite IS NULL " +
                    "AND p.wood5_haul_psite IS NULL AND p.wood6_haul_psite IS NULL)";
                if (frmMain.g_bDebug && frmMain.g_intDebugLevel > 1)
                ...
                if ((bool)frmMain.g_oDelegate.GetControlPropertyValue((System.Windows.Forms.Control)oCheckBox, "Checked", false) == true)
                {
                    ...
                    p_dataMgr.m_strSQL = "UPDATE " + Tables.Audit.DefaultCondAuditTableName + " AS a " +
                        ...
                        "psite_wood4_yn = CASE WHEN p.wood4_haul_psite IS NULL THEN 'N' ELSE 'Y' END," +
                        "psite_wood5_yn = CASE WHEN p.wood5_haul_psite IS NULL THEN 'N' ELSE 'Y' END," +
                        "psite_wood6_yn = CASE WHEN p.wood6_haul_psite IS NULL THEN 'N' ELSE 'Y' END " +
                        "FROM " + Tables.OptimizerScenarioResults.DefaultScenarioResultsPSiteAccessibleWorkTableName + " AS p " +
        ...
        private void Effective()
        {
            ...
            using (System.Data.SQLite.SQLiteConnection resultsConn = new System.Data.SQLite.SQLiteConnection(p_dataMgr.GetConnectionString(this.m_strSystemResultsDbPathAndFile)))
            {
                ...
                p_dataMgr.m_strSQL = "ATTACH DATABASE '" + frmMain.g_oFrmMain.frmProject.uc_project1.m_strProjectDirectory.Trim() + "\\" + Tables.OptimizerScenarioResults.DefaultCalculatedPrePostFVSVariableTableDbFile + "' AS fvs_weighted";
                p_dataMgr.SqlNonQuery(resultsConn, p_dataMgr.m_strSQL);

                //attach FVS prepost
                p_dataMgr.m_strSQL = "ATTACH DATABASE '" + frmMain.g_oFrmMain.frmProject.uc_project1.m_strProjectDirectory.Trim() + Tables.FVS.DefaultFVSOutPrePostDbFile + "' AS fvs_out";
                p_dataMgr.SqlNonQuery(resultsConn, p_dataMgr.m_strSQL);
        ...
        private void Optimization()
        {
            ...
            using (System.Data.SQLite.SQLiteConnection resultsConn = new System.Data.SQLite.SQLiteConnection(p_dataMgr.GetConnectionString(this.m_strSystemResultsDbPathAndFile)))
            {
                ...
                else if (this.m_oOptimizationVariable.strOptimizedVariable.Trim().ToUpper() == "WOOD4 VOLUME")
                {
                    p_dataMgr.m_strSQL = "UPDATE " + strOptimizationTableName +
                        " SET pre_variable_name = 'p.wood4_vol_cf', post_variable_name = 'p.wood4_vol_cf', " +
                        "pre_variable_value = CASE WHEN p.wood4_vol_cf IS NOT NULL THEN p.wood4_vol_cf ELSE 0 END, " +
                        "post_variable_value = CASE WHEN p.wood4_vol_cf IS NOT NULL THEN p.wood4_vol_cf ELSE 0 END, " +
                        "change_value = 0 " +
                        "FROM " + strOptimizationTableName + " AS e LEFT JOIN " + Tables.OptimizerScenarioResults.DefaultScenarioResultsEconByRxCycleTableName + " AS p " +
                        "ON e.biosum_cond_id = p.biosum_cond_id AND e.rxpackage = p.rxpackage AND e.rx = p.rx AND e.rxcycle AND p.rxcycle";
                }
                else if (this.m_oOptimizationVariable.strOptimizedVariable.Trim().ToUpper() == "WOOD5 VOLUME")
                {
                    p_dataMgr.m_strSQL = "UPDATE " + strOptimizationTableName +
                        " SET pre_variable_name = 'p.wood5_vol_cf', post_variable_name = 'p.wood5_vol_cf', " +
                        "pre_variable_value = CASE WHEN p.wood5_vol_cf IS NOT NULL THEN p.wood5_vol_cf ELSE 0 END, " +
                        "post_variable_value = CASE WHEN p.wood5_vol_cf IS NOT NULL THEN p.wood5_vol_cf ELSE 0 END, " +
                        "change_value = 0 " +
                        "FROM " + strOptimizationTableName + " AS e LEFT JOIN " + Tables.OptimizerScenarioResults.DefaultScenarioResultsEconByRxCycleTableName + " AS p " +
                        "ON e.biosum_cond_id = p.biosum_cond_id AND e.rxpackage = p.rxpackage AND e.rx = p.rx AND e.rxcycle AND p.rxcycle";
                }
                else if (this.m_oOptimizationVariable.strOptimizedVariable.Trim().ToUpper() == "WOOD6 VOLUME")
                {
                    p_dataMgr.m_strSQL = "UPDATE " + strOptimizationTableName +
                        " SET pre_variable_name = 'p.wood6_vol_cf', post_variable_name = 'p.wood6_vol_cf', " +
                        "pre_variable_value = CASE WHEN p.wood6_vol_cf IS NOT NULL THEN p.wood6_vol_cf ELSE 0 END, " +
                        "post_variable_value = CASE WHEN p.wood6_vol_cf IS NOT NULL THEN p.wood6_vol_cf ELSE 0 END, " +
                        "change_value = 0 " +
                        "FROM " + strOptimizationTableName + " AS e LEFT JOIN " + Tables.OptimizerScenarioResults.DefaultScenarioResultsEconByRxCycleTableName + " AS p " +
                        "ON e.biosum_cond_id = p.biosum_cond_id AND e.rxpackage = p.rxpackage AND e.rx = p.rx AND e.rxcycle AND p.rxcycle";
                }
                else if (this.m_oOptimizationVariable.strOptimizedVariable.Trim().ToUpper() == "NON-RESIDUE VOLUME")
                {
                    p_dataMgr.m_strSQL = "UPDATE " + strOptimizationTableName +
                        " SET pre_variable_name = 'p.non_residue_vol_cf', post_variable_name = 'p.non_residue_vol_cf', " +
                        "pre_variable_value = CASE WHEN p.non_residue_vol_cf IS NOT NULL THEN p.non_residue_vol_cf ELSE 0 END, " +
                        "post_variable_value = CASE WHEN p.non_residue_vol_cf IS NOT NULL THEN p.non_residue_vol_cf ELSE 0 END, " +
                        "change_value = 0 " +
                        "FROM " + strOptimizationTableName + " AS e LEFT JOIN " + Tables.OptimizerScenarioResults.DefaultScenarioResultsEconByRxCycleTableName + " AS p " +
                        "ON e.biosum_cond_id = p.biosum_cond_id AND e.rxpackage = p.rxpackage AND e.rx = p.rx AND e.rxcycle AND p.rxcycle";
                }
                        ...
                        if (strCol[strCol.Length - 1] == "1")
                        {
                            ...
                            else if (oItem.strFVSVariableName.Equals("total_volume_1"))
                            {
                                p_dataMgr.m_strSQL = "UPDATE tiebreaker AS e " +
                                    "SET pre_variable1_name = '" + oItem.strFVSVariableName + "', " +
                                    "post_variable1_name = '" + oItem.strFVSVariableName + "', " +
                                    "pre_variable1_value = CASE WHEN p.chip_vol_cf_utilized + p.non_residue_vol_cf IS NOT NULL THEN p.chip_vol_cf_utilized + p.non_residue_vol_cf ELSE 0 END, " +
                                    "post_variable1_value = CASE WHEN p.chip_vol_cf_utilized + p.non_residue_vol_cf IS NOT NULL THEN p.chip_vol_cf_utilized + p.non_residue_vol_cf ELSE 0 END, " +
                                    "variable1_change = 0 " +
        ...
        private void econ_by_rx_cycle()
        {
            ...
            using (System.Data.SQLite.SQLiteConnection workConn = new System.Data.SQLite.SQLiteConnection(m_strWorkTablesConn))
            {
                ...
                string strScenarioDb = frmMain.g_oFrmMain.frmProject.uc_project1.m_strProjectDirectory + "\\" + Tables.OptimizerScenarioRuleDefinitions.DefaultScenarioTableDbFile;
                ...
                string[] columnsFromTreeVolValSum = { "merch_vol_cf", "chip_vol_cf", "wood4_vol_cf", "wood5_vol_cf", "wood6_vol_cf", 
                    "merch_wt_gt", "chip_wt_gt", "wood4_wt_gt", "wood5_wt_gt", "wood6_wt_gt", "merch_val_dpa", "chip_val_dpa", "wood4_val_dpa", "wood5_val_dpa", "wood6_val_dpa", "non_residue_vol_cf" };
                ...
                p_dataMgr.m_strSQL = "INSERT INTO " + m_strEconByRxWorkTableName +
                    ...
                    "wood4_wt_gt, wood5_wt_gt, wood6_wt_gt, merch_val_dpa, chip_val_dpa, wood4_val_dpa, wood5_val_dpa, wood6_val_dpa, non_residue_vol_cf, " +
                    ...
                    "CASE WHEN psa.wood4_haul_cst_dpgt IS NOT NULL THEN " +
                ...
                p_dataMgr.m_strSQL = "UPDATE " + m_strEconByRxWorkTableName +
                    ...
                    "wood4_haul_cost_dpa = escalator_wood4_haul_cpa_pt * wood4_wt_gt, " +
                    "wood5_haul_cost_dpa = escalator_wood5_haul_cpa_pt * wood5_wt_gt, " +
                    "wood6_haul_cost_dpa = escalator_wood6_haul_cpa_pt * wood6_wt_gt";
                if (frmMain.g_bDebug && frmMain.g_intDebugLevel > 2)
                    frmMain.g_oUtils.WriteText(m_strDebugFile, "Execute SQL: " + p_dataMgr.m_strSQL + "\r\n");
                p_dataMgr.SqlNonQuery(workConn, p_dataMgr.m_strSQL);
                ...
                string strSelectSQL = "SELECT vc.biosum_cond_id, vc.rxpackage, vc.rx, vc.rxcycle, " +
                            "0 AS merch_vol_cf, 0 as chip_vol_cf, 0 AS wood4_vol_cf, 0 AS wood5_vol_cf, wood6_vol_cf, 0 as chip_wt_gt, " +
                            "0 as chip_val_dpa, 0 as merch_wt_gt, 0 AS merch_val_dpa, 0 AS wood4_wt_gt, 0 AS wood4_val_dpa, " +
                            "0 AS wood5_wt_gt, 0 AS wood5_val_dpa, 0 AS wood6_wt_gt, 0 AS wood6_val_dpa, 0 AS non_residue_vol_cf, " +
                ...
                fieldsAndDataTypes += "merch_vol_cf INTEGER, chip_vol_cf INTEGER, wood4_vol_cf INTEGER, wood5_vol_cf INTEGER, wood6_vol_cf INTEGER, " +
                    ...
                    "wood6_wt_gt INTEGER, wood6_val_dpa INTEGER, non_residue_vol_cf INTEGER";
                ...
                fieldsAndDataTypes += "escalator_merch_haul_cpa_pt INTEGER, escalator_wood4_haul_cpa_pt INTEGER, escalator_wood5_haul_cpa_pt INTEGER, escalator_wood6_haul_cpa_pt INTEGER, " +
                    ...
                    "merch_chip_nr_dpa INTEGER, merch_nr_dpa INTEGER, wood4_nr_dpa INTEGER, wood5_nr_dpa INTEGER, max_nr_dpa INTEGER, ";
                ...
                p_dataMgr.m_strSQL = "INSERT INTO " + m_strEconByRxWorkTableName +
                    ...
                    "isw.wood5_val_dpa, isw.wood6_wt_gt, isw.wood6_val_dpa, isw.non_residue_vol_cf, " +
                ...
                p_dataMgr.m_strSQL = "INSERT INTO " + Tables.OptimizerScenarioResults.DefaultScenarioResultsEconByRxCycleTableName +
                                    ...
                                    "non_residue_vol_cf,harvest_onsite_cost_dpa," +
                ...
                try
                {
                    using (System.Data.SQLite.SQLiteConnection econConn = new System.Data.SQLite.SQLiteConnection(strEconConn))
                    {
                        ...
                        while (p_dataMgr.m_DataReader.Read())
                        {
                            ...
                            double dblWood4YieldCf = Convert.ToDouble(p_dataMgr.m_DataReader["wood4_vol_cf"]);
                                ...
                                foreach (string strFieldName in lstFieldNames)
                                {
                                    ...
                                    switch (strFieldType)
                                    {
                                        case uc_optimizer_scenario_calculated_variables.PREFIX_MERCH_VOLUME:
                                            ...
                                            break;
                                        case uc_optimizer_scenario_calculated_variables.PREFIX_WOOD4_VOLUME:
                                            lstFieldValues.Add(oSavedProductYields.Wood4YieldCfCycle1() * lstWeights[0]);
                                            lstFieldValues.Add(oSavedProductYields.Wood4YieldCfCycle2() * lstWeights[1]);
                                            lstFieldValues.Add(oSavedProductYields.Wood4YieldCfCycle3() * lstWeights[2]);
                                            lstFieldValues.Add(oSavedProductYields.Wood4YieldCfCycle4() * lstWeights[3]);
                                            lstFieldValues.Add(oSavedProductYields.Wood4YieldCfCycle1() * lstWeights[0] +
                                                               oSavedProductYields.Wood4YieldCfCycle2() * lstWeights[1] +
                                                               oSavedProductYields.Wood4YieldCfCycle3() * lstWeights[2] +
                                                               oSavedProductYields.Wood4YieldCfCycle4() * lstWeights[3]);
                                            break;
                                        case uc_optimizer_scenario_calculated_variables.PREFIX_WOOD5_VOLUME:
                                            lstFieldValues.Add(oSavedProductYields.Wood5YieldCfCycle1() * lstWeights[0]);
                                            lstFieldValues.Add(oSavedProductYields.Wood5YieldCfCycle2() * lstWeights[1]);
                                            lstFieldValues.Add(oSavedProductYields.Wood5YieldCfCycle3() * lstWeights[2]);
                                            lstFieldValues.Add(oSavedProductYields.Wood5YieldCfCycle4() * lstWeights[3]);
                                            lstFieldValues.Add(oSavedProductYields.Wood5YieldCfCycle1() * lstWeights[0] +
                                                               oSavedProductYields.Wood5YieldCfCycle2() * lstWeights[1] +
                                                               oSavedProductYields.Wood5YieldCfCycle3() * lstWeights[2] +
                                                               oSavedProductYields.Wood5YieldCfCycle4() * lstWeights[3]);
                                            break;
                                        case uc_optimizer_scenario_calculated_variables.PREFIX_WOOD6_VOLUME:
                                            lstFieldValues.Add(oSavedProductYields.Wood6YieldCfCycle1() * lstWeights[0]);
                                            lstFieldValues.Add(oSavedProductYields.Wood6YieldCfCycle2() * lstWeights[1]);
                                            lstFieldValues.Add(oSavedProductYields.Wood6YieldCfCycle3() * lstWeights[2]);
                                            lstFieldValues.Add(oSavedProductYields.Wood6YieldCfCycle4() * lstWeights[3]);
                                            lstFieldValues.Add(oSavedProductYields.Wood6YieldCfCycle1() * lstWeights[0] +
                                                               oSavedProductYields.Wood6YieldCfCycle2() * lstWeights[1] +
                                                               oSavedProductYields.Wood6YieldCfCycle3() * lstWeights[2] +
                                                               oSavedProductYields.Wood6YieldCfCycle4() * lstWeights[3]);
                                            break;
        ...
        private void econ_by_rx_utilized_sum()
        {
            ...
            using (System.Data.SQLite.SQLiteConnection workConn = new System.Data.SQLite.SQLiteConnection(m_strWorkTablesConn))
            {
                ...
                p_dataMgr.m_strSQL = "INSERT INTO " + Tables.OptimizerScenarioResults.DefaultScenarioResultsEconByRxUtilSumTableName +
                    ...
                    "merch_val_dpa, wood4_val_dpa, wood5_val_dpa, wood6_val_dpa, non_residue_vol_cf, harvest_onsite_cost_dpa, chip_haul_cost_dpa_utilized, merch_haul_cost_dpa, " +
                    ...
                    "a.sum_non_residue_yield_cf AS non_residue_vol_cf, a.sum_harvest_onsite_dpa AS harvest_onsite_cost_dpa, a.sum_haul_chip_dpa AS chip_haul_cost_dpa_utilized, " +
                    ...
                    "SUM(IFNULL(wood4_vol_cf, 0)) AS sum_wood4_yield_cf, SUM(IFNULL(wood5_vol_cf, 0)) AS sum_wood5_yield_cf, SUM(IFNULL(wood6_vol_cf)) AS sum_wood6_yield_cf, " +
                    ...
                    "SUM(IFNULL(wood6_val_dpa, 0)) AS sum_wood6_val_dpa, SUM(IFNULL(non_residue_vol_cf, 0)) AS sum_non_residue_yield_cf, " +
                ...
                for (int arrIdx = 0; arrIdx < 4; arrIdx++)
                {
                    p_dataMgr.m_strSQL = "UPDATE " + strTreeSumWorktableName +
                        ...
                        "CASE WHEN a.chip_vol_cf > 0 AND (a.merch_vol_cf OR a.wood4_vol_cf OR a.wood5_vol_cf OR a.wood6_vol_cf) > 0 THEN '3' " +
                        "WHEN a.chip_vol_cf = 0 AND a.merch_vol_cf = 0 THEN '0' " +
                        "WHEN a.chip_vol_cf > 0 THEN '2' ELSE '1' END " +
                        "FROM (SELECT biosum_cond_id, rxpackage, rxcycle, chip_vol_cf, merch_vol_cf, wood4_vol_cf, wood5_vol_cf, wood6_vol_cf FROM econ_by_rx_cycle) AS a " +
        ...
        private void CreateTableStructureForScenarioProcessingSites()
        {
            ...
            ***********************************************************************/
            ...
            using (System.Data.SQLite.SQLiteConnection workConn = new System.Data.SQLite.SQLiteConnection(m_strWorkTablesConn))
            {
                ...
                string strRuleDefinitionsDb = frmMain.g_oFrmMain.frmProject.uc_project1.m_strProjectDirectory.Trim() + "\\" + Tables.OptimizerScenarioRuleDefinitions.DefaultScenarioTableDbFile;
        ...
        private void CondPsiteTable()
        {
            ...
            using (System.Data.SQLite.SQLiteConnection workConn = new System.Data.SQLite.SQLiteConnection(m_strWorkTablesConn))
            {
                ...
                " (BIOSUM_COND_ID,MERCH_PSITE_NUM,MERCH_PSITE_NAME,CHIP_PSITE_NUM,CHIP_PSITE_NAME,WOOD4_PSITE_NUM,WOOD4_PSITE_NAME," +
                "WOOD5_PSITE_NUM,WOOD5_PSITE_NAME,WOOD6_PSITE_NUM,WOOD6_PSITE_NAME) " +
                "SELECT a.biosum_cond_id, a.merch_haul_psite, a.merch_haul_psite_name, a.chip_haul_psite, a.chip_haul_psite_name " +
                "a.wood4_haul_psite, a.wood4_haul_psite_name, a.wood5_haul_psite, a.wood5_haul_psite_name, a.wood6_haul_psite, a.wood6_haul_psite_name " +
        ...
        private void ContextReferenceTables()
        {
            ...
            using (System.Data.SQLite.SQLiteConnection contextConn = new System.Data.SQLite.SQLiteConnection(p_dataMgr.GetConnectionString(m_strContextDbPathAndFile)))
            {
                ...
                p_dataMgr.m_strSQL = "ATTACH DATABASE '" + frmMain.g_oFrmMain.frmProject.uc_project1.m_strProjectDirectory.Trim() + "\\" + Tables.OptimizerDefinitions.DefaultDbFile + "' AS optimizer_defs";
                p_dataMgr.SqlNonQuery(contextConn, p_dataMgr.m_strSQL);

                p_dataMgr.m_strSQL = "ATTACH DATABASE '" + m_strProcessorResultsPathAndFile + "' AS processor_results";
                p_dataMgr.SqlNonQuery(contextConn, p_dataMgr.m_strSQL);

                p_dataMgr.m_strSQL = "ATTACH DATABASE '" + frmMain.g_oFrmMain.frmProject.uc_project1.m_strProjectDirectory.Trim() + "\\processor\\" + Tables.ProcessorScenarioRuleDefinitions.DefaultDbFile + "' AS processor_rules";
                p_dataMgr.SqlNonQuery(contextConn, p_dataMgr.m_strSQL);

                p_dataMgr.m_strSQL = "ATTACH DATABASE '" + frmMain.g_oFrmMain.frmProject.uc_project1.m_strProjectDirectory.Trim() + "\\" + Tables.OptimizerScenarioRuleDefinitions.DefaultScenarioTableDbFile + "' AS optimizer_rules";
                p_dataMgr.SqlNonQuery(contextConn, p_dataMgr.m_strSQL);
    ...
    public class ProductYields
    {
            ...
            double dblMaxNrDpaCycle, double dblHaulMerchCpa, double dblMerchChipNrDpa, double dblHaulChipCpa)
        {
            ...
            _dblWood4YieldCfCycle1 = dblWood4YieldCf;
            ...
            double dblMaxNrDpaCycle, double dblHaulMerchCpa, double dblMerchChipNrDpa, double dblHaulChipCpa)
        {
            ...
            _dblWood4YieldCfCycle2 = dblWood4YieldCf;
            ...
            double dblMaxNrDpaCycle, double dblHaulMerchCpa, double dblMerchChipNrDpa, double dblHaulChipCpa)
        {
            ...
            _dblWood4YieldCfCycle3 = dblWood4YieldCf;
            ...
            double dblMaxNrDpaCycle, double dblHaulMerchCpa, double dblMerchChipNrDpa, double dblHaulChipCpa)
        {
            ...
            _dblWood4YieldCfCycle4 = dblWood4YieldCf;
        ...
        public double Wood4YieldCfCycle1()
        {
            return _dblWood4YieldCfCycle1;
        }
        public double Wood4YieldCfCycle2()
        {
            return _dblWood4YieldCfCycle2;
        }
        public double Wood4YieldCfCycle3()
        {
            return _dblWood4YieldCfCycle3;
        }
        public double Wood4YieldCfCycle4()
        {
            return _dblWood4YieldCfCycle4;
        }
        public double Wood5YieldCfCycle1()
        {
            return _dblWood5YieldCfCycle1;
        }
        public double Wood5YieldCfCycle2()
        {
            return _dblWood5YieldCfCycle2;
        }
        public double Wood5YieldCfCycle3()
        {
            return _dblWood5YieldCfCycle3;
        }
        public double Wood5YieldCfCycle4()
        {
            return _dblWood5YieldCfCycle4;
        }
        public double Wood6YieldCfCycle1()
        {
            return _dblWood6YieldCfCycle1;
        }
        public double Wood6YieldCfCycle2()
        {
            return _dblWood6YieldCfCycle2;
        }
        public double Wood6YieldCfCycle3()
        {
            return _dblWood6YieldCfCycle3;
        }
        public double Wood6YieldCfCycle4()
        {
            return _dblWood6YieldCfCycle4;
        }
